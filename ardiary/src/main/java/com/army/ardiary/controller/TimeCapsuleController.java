...
public class TimeCapsuleController {
    ...
    public ResponseEntity<?> writeTimeCapsule(@RequestHeader(value = "Authorization") String bToken, @RequestBody TimeCapsuleDto timeCapsuleDto) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(timeCapsuleDto);
    }
}
